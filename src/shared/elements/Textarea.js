...
class TextareaRaw extends Component {
    ...
    render() {
        ...
        return <textarea onChange={this.handleOnChange}  {...passthroughProps} value={this.state.value} />;
    }
}

export const Textarea = styled(TextareaRaw)`
    outline: none;
    padding: 20px 10px;
    margin: 8px 0;
    width: 100%;
...
export const TextareaControl = formControl(Textarea);